...
(define-fun ours ( (mc_i Int)  (MAXDATA Int)  (cp1_off Int) ) Bool (and (<= (- mc_i) 0)(<= (- cp1_off) 0)(<= (+ (- MAXDATA) mc_i) (- 1))(<= (- (- MAXDATA) cp1_off) (- 2)))) 
(define-fun evo ( (mc_i Int)  (MAXDATA Int)  (cp1_off Int) ) Bool (and (<= (- mc_i) 0)(<= (- cp1_off) 0)))
