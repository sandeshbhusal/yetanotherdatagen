...
(define-fun ours ( (c Int)  (ac Int)  (ab Int)  (a Int)  (b Int)  (bc Int) ) Bool (and (= (+ (- b bc) c) 0)(= (+ (- a ac) c) 0)(= (+ (- (- ab ac) bc) (* 2 c)) 0)(<= (- a bc) (- 1))(<= (+ (- ac) b) (- 1))(<= (+ (- ab) c) (- 1)))) 
(define-fun evo ( (c Int)  (ac Int)  (ab Int)  (a Int)  (b Int)  (bc Int) ) Bool (and (= (+ (- b bc) c) 0)(= (+ (- a ac) c) 0)(= (+ (- (- ab ac) bc) (* 2 c)) 0)(<= (- a bc) (- 1))(<= (+ (- ac) b) (- 1))(<= (+ (- ab) c) (- 1))))
