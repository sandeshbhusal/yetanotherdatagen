public class Cars {
    ...
    public static void cars(int unknown_int, boolean innerif, int v1, int v2, int v3) {
        ...
        if (true && !(unknown_int == 715) && !(unknown_int == -4040) && !(unknown_int == 2) && !(unknown_int == 65) && !(unknown_int == 2958) && !(unknown_int == 4) && !(unknown_int == -4) && !(unknown_int == 3785) && !(unknown_int == 5) && !(unknown_int == 0) && !(unknown_int == -967) && !(unknown_int == -3673) && !(unknown_int == -5) && !(unknown_int == -2584) && !(unknown_int == 1) && !(unknown_int == -1) && !(unknown_int == 3412) && !(unknown_int == 3412)) {
