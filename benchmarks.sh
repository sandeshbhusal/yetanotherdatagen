...
aug_target() {
    ...
    local WORKDIR="${BENCHMARK_DIR}/outputs_${ITERATIONS}/${BENCH_TARGET}/checkpoint_datagen"
...
noaug_target() {
    local BENCH_TARGET="$1"
    local TARGET_DIR="${BENCHMARK_DIR}/inputs/${BENCH_TARGET}"
    local WORKDIR="${BENCHMARK_DIR}/outputs_${ITERATIONS}/${BENCH_TARGET}/checkpoint_nodatagen"
