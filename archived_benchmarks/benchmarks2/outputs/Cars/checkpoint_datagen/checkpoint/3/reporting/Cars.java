...
public class Cars {
    ...
    public static void cars(int unknown_int, boolean innerif, int v1, int v2, int v3) {
        ...
        Report.datagen_guard_instrument(18735, "entermethod", "unknown_int", unknown_int, "v1", v1, "v2", v2, "v3", v3);
        ...
        if (cond1 && cond2 && cond3 && cond4 && cond5 && cond6) {
            while (unknown_int > 0) {
                ...
                if (!(c1 && c2))
                    break;
                Report.datagen_instrument(18735, "loopinv", "v2", v2);
                // assume(v2 + 5 >= 0);
                // assume(v2 <= 5);
                if (innerif) {
                    Report.datagen_instrument(18735, "loopinvtrue", "x1", x1, "x2", x2, "x3", x3);
                    // assume(2 * x2 - x1 - x3 >= 0);
                    x1 = x1 + v1;
                    x3 = x3 + v3;
                    x2 = x2 + v2;
                    ...
                    Report.datagen_instrument(18735, "loopinvfalse", "x1", x1, "x2", x2, "x3", x3);
                    // assume(2 * x2 - x1 - x3 <= 0);
                    x1 = x1 + v1;
                    x3 = x3 + v3;
                    x2 = x2 + v2;
        ...
        Report.datagen_instrument(18735, "exitloop", "v1", v1, "v2", v2, "v3", v3, "t", t);
    }
}
