...
(define-fun ours ( (c Int)  (ac Int)  (ab Int)  (a Int)  (b Int)  (bc Int) ) Bool (and (> ab ac)(> ab c)(>= b ac)(> b c)(= (+ (- a ab) b) 0)(= (+ (- a ac) c) 0)(= (- (- bc b) c) 0))) 
(define-fun evo ( (c Int)  (ac Int)  (ab Int)  (a Int)  (b Int)  (bc Int) ) Bool (and (> ab ac)(> ab c)(>= b ac)(> b c)(= (+ (- a ab) b) 0)(= (+ (- a ac) c) 0)(= (- (- bc b) c) 0)))
