...
(define-fun ours ( (MAXDATA Int)  (mc_i Int)  (cp1_off Int) ) Bool (and (<= (- mc_i) 0)(<= (- cp1_off) 0)(<= (+ (- MAXDATA) cp1_off) 0)(<= (min2 cp1_off (- (- mc_i MAXDATA) 1)) 0))) 
(define-fun evo ( (MAXDATA Int)  (mc_i Int)  (cp1_off Int) ) Bool (and (<= (- mc_i) 0)(<= (- cp1_off) 0)(<= (+ (- MAXDATA) cp1_off) 0)))
