...
(define-fun ours ( (bc Int)  (a Int)  (ab Int)  (b Int)  (c Int)  (ac Int) ) Bool (and (<= ab c)(= (+ (- a ab) b) 0)(= (+ (- a ac) c) 0)(= (- (- bc b) c) 0))) 
(define-fun evo ( (bc Int)  (a Int)  (ab Int)  (b Int)  (c Int)  (ac Int) ) Bool (and (<= ab c)(= (+ (- a ab) b) 0)(= (+ (- a ac) c) 0)(= (- (- bc b) c) 0)))
