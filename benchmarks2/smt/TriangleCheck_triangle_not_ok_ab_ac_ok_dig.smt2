...
(define-fun ours ( (bc Int)  (a Int)  (ab Int)  (b Int)  (c Int)  (ac Int) ) Bool (and (= (+ (- b bc) c) 0)(= (+ (- a ac) c) 0)(= (+ (- (- ab ac) bc) (* 2 c)) 0)(<= (+ (- a) bc) 0)(<= (+ (- ab) c) (- 1))(<= (+ (- ac) b) (- 1)))) 
(define-fun evo ( (bc Int)  (a Int)  (ab Int)  (b Int)  (c Int)  (ac Int) ) Bool (and (= (+ (- b bc) c) 0)(= (+ (- a ac) c) 0)(= (+ (- (- ab ac) bc) (* 2 c)) 0)(<= (+ (- a) bc) 0)(<= (+ (- ac) b) (- 1))(<= (+ (- ab) c) (- 1))))
