...
(define-fun ours ( (c Int)  (a Int)  (b Int)  (ac Int)  (ab Int)  (bc Int) ) Bool (and (= (+ (- b bc) c) 0)(= (+ (- a ac) c) 0)(= (+ (- (- ab ac) bc) (* 2 c)) 0)(<= (- a bc) (- 1))(<= (+ (- ab) c) (- 1))(<= (+ (- ac) b) (- 1)))) 
(define-fun evo ( (c Int)  (a Int)  (b Int)  (ac Int)  (ab Int)  (bc Int) ) Bool (and (= (+ (- a ac) c) 0)(= (+ (- b bc) c) 0)(= (+ (- (- ab ac) bc) (* 2 c)) 0)(<= (- a bc) (- 1))(<= (+ (- ab) c) (- 1))(<= (+ (- ac) b) (- 1))))
