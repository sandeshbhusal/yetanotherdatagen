...
(define-fun ours ( (c Int)  (a Int)  (b Int)  (ac Int)  (ab Int)  (bc Int) ) Bool (and (= (+ (- a ac) c) 0)(= (+ (- b bc) c) 0)(= (+ (- (- ab ac) bc) (* 2 c)) 0)(<= (- ab c) 0))) 
(define-fun evo ( (c Int)  (a Int)  (b Int)  (ac Int)  (ab Int)  (bc Int) ) Bool (and (= (+ (- a ac) c) 0)(= (+ (- b bc) c) 0)(= (+ (- (- ab ac) bc) (* 2 c)) 0)(<= (- ab c) 0)))
