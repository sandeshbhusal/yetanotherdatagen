...
(define-fun ours ( (c Int)  (a Int)  (b Int)  (ac Int)  (ab Int)  (bc Int) ) Bool (and (>= b 1)(>= c 1)(< a ab)(< a bc)(< a ac)(> ab b)(> ab c)(> bc b)(> bc c)(< b ac)(> ac c)(= (+ (- a ab) b) 0)(= (+ (- a ac) c) 0)(= (- (- bc b) c) 0))) 
(define-fun evo ( (c Int)  (a Int)  (b Int)  (ac Int)  (ab Int)  (bc Int) ) Bool (and (< a ab)(< a bc)(< a ac)(> ab b)(> ab c)(> bc b)(> bc c)(< b ac)(> ac c)(= (+ (- a ab) b) 0)(= (+ (- a ac) c) 0)(= (- (- bc b) c) 0)))
