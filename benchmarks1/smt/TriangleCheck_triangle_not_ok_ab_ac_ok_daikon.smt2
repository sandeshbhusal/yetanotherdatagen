...
(define-fun ours ( (c Int)  (a Int)  (b Int)  (ac Int)  (ab Int)  (bc Int) ) Bool (and (>= a bc)(> a b)(> a c)(> ab bc)(> ab b)(> ab c)(< bc ac)(< b ac)(> ac c)(= (+ (- a ab) b) 0)(= (+ (- a ac) c) 0)(= (- (- bc b) c) 0))) 
(define-fun evo ( (c Int)  (a Int)  (b Int)  (ac Int)  (ab Int)  (bc Int) ) Bool (and (>= a bc)(> a b)(> a c)(> ab bc)(> ab b)(> ab c)(< bc ac)(< b ac)(> ac c)(= (+ (- a ab) b) 0)(= (+ (- a ac) c) 0)(= (- (- bc b) c) 0)))
